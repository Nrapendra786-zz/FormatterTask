...
/**
 * This class is used for formatting content to Left
 */
public class LeftFormatter implements IFormatter {


    /**
     * This method is used for formatting content to left
    ...
    public String format(int noOfCharacters,String inputContent) {
        ...
        for(int i = 0 ; i < stringArray.length ; i = i +noOfCharacters){
            if( i <= stringArray.length - noOfCharacters) {
                ...
                stringBuilderTwo.append(Message.LEFT_SPACE + value).append(Message.CHANGE_LINE);
